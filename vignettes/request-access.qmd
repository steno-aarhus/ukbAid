...
5.  Read through everything on this website and make sure you understand
    what we expect of you and what you need to do (and NOT do) when working
    with the UK Biobank data. In particular read through the [Important
    Notes](important-notes.qmd) page.

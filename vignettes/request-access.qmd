...
5.  Read through everything on this website and make sure you understand
    what we expect of you and what you need to do (and NOT do) when
    working with the UK Biobank data. In particular read through the
    [Important Notes](important-notes.qmd) page.

::: callout-important
A project in this sense would be considered a Git repository (hosted on
GitHub). And one project should link to *only one* paper. So 1 project =
1 Git repository = 1 published paper.
:::
...
::: callout-important
Finished your project but still want to publish more papers based on
your work? You need to submit a new project proposal then! One project
should link to only one paper, which should only link to one GitHub
repository. Once your paper is finished and published, we will upload
your project (with the code) to Zenodo and convert the project to
archived state. Which means you can't work on it anymore. So you need to
make a new project proposal to work on a new paper. You can always copy
the code from the previous project, it never disappears.
:::

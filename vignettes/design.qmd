...
-   require zero to two arguements
...
proj_create_database(fields, output_path)
proj_create_path_database(user)
```
...
-   Objects: file, repo, metadata, record, token
-   Actions: create, get,

```         
zen_get_token()
zen_create_file_metadata(path)
zen_create_repo_metadata(path)
